# TODO: find_neighbors_round - рекурсия. Затем область видимости
...
# TODO: заменить таймер "полосой загрузки" Progressbar. Выровнять его по центру
...
# TODO: При количестве колец больше 10 - сбивается центр поля гексов
